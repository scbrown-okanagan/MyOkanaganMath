...
?>
<link rel="stylesheet" href="<?php echo $staticroot . "/imascore.css?ver=072221";?>" type="text/css" />
<?php
...
<script type="text/javascript" src="<?php echo $staticroot;?>/javascript/general.js?v=112721"></script>
<?php
//$_SESSION['mathdisp'] = 3;
//
if (isset($CFG['locale'])) {
